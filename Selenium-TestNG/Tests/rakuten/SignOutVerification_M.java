...
@Guice(moduleFactory = GuiceInjection.class)
	public class SignOutVerification_M {
		...
		@Inject
	    SignOutPageAction signOutPageAction;
		@Inject
		...
		public void TC_Point_Club_Verification(String url, String username, String password) throws BiffException, IOException {																	
			...
			topPageAction.SignOut();		
			signOutPageAction.VerifyUrl(url);
			signOutPageAction.VerifyPageUI();
			signOutPageAction.VerifyLanguage(url);
		}
}
