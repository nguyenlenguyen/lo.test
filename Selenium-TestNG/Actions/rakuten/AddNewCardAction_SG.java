...
public class AddNewCardAction_SG extends AddNewCardAction{
	
	@Inject private AddNewCardEntity_SG addNewCardEntity;
	...
	public void CheckControlsExist(){
		...
		QTiumAssert.verifyEquals(QTiumAutomation.isElementExists(addNewCardEntity.AmexCardIconImage()), true);
