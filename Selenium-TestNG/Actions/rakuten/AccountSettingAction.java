package rakuten;
import rakuten.AccountSettingEntity;

import com.google.inject.Inject;
import com.logigear.selenium.QTiumAssert;
import com.logigear.selenium.QTiumAutomation;

public class AccountSettingAction  {
	
	@Inject private AccountSettingEntity accountSettingEntity;
		

	public void verifyAccountSettingURL(){
		
		MyAccountAction.checkURLOpened("top_username_6");
	}		
	 ...
	 public void CheckControlsExist(){
		...
		QTiumAssert.verifyEquals(QTiumAutomation.isElementExists(accountSettingEntity.LastNameLabel()), true);
